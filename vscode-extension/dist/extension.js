...
async function processCode(mode) {
    ...
    const panel = vscode.window.createWebviewPanel('codeExplanation', panelTitle, vscode.ViewColumn.Beside, { enableScripts: true });
...
function fetchExplanationFromAPI(code, language, mode) {
...
function getResultHtml(jsonString, mode) {
    let data;
    try {
